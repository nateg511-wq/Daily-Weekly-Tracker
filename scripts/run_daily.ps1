...
# Without this, any python subprocess printing a literal Unicode minus sign
# (U+2212, used throughout engine/blend.py and engine/digest.py) crashes on
# this machine's default cp1252 console encoding -- observed 2026-09-10,
# worked around ad hoc inside that day's session but would otherwise fail
# an unattended scheduled run outright. Child processes (the claude.exe this
# script launches, and any python it in turn runs) inherit this.
